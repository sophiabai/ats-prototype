...
const initialPools: CandidatePool[] = [
  {
    id: 'pool-1',
    title: 'Bay area ML engineers open for work',
  ...
  {
    id: 'pool-2',
    title: 'SF SaaS product designers',
  ...
  {
    id: 'pool-3',
    title: 'Seattle SaaS product managers',
  ...
  {
    id: 'pool-4',
    title: 'AI product designers open to work',
  ...
  {
    id: 'pool-5',
    title: 'SF Growth product designers',
  ...
  {
    id: 'pool-6',
    title: 'NYC Full-stack engineers open to opportunities',
  ...
  {
    id: 'pool-7',
    title: 'Austin DevOps engineers with Kubernetes experience',
  ...
  {
    id: 'pool-8',
    title: 'Remote Data scientists Python R',
